...
public class PersonaLista {
	...
	public void nuevo(){
		...
		Window ventanaCargar = (Window) Executions.createComponents("/mvvm/personaEditar.zul", null, params);
	...
	public void agendaNuevo(){
		...
		Window ventanaCargar = (Window) Executions.createComponents("/mvvm/personaAgendaEditar.zul", null, params);
		ventanaCargar.doModal();
